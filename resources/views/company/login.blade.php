...
<head>
    ...
    <title>Company Login | {{ env('APP_NAME') }}</title>
        ...
        <section class="bg-white/50 min-h-screen flex flex-col items-center justify-center">
            ...
            <section data-aos="zoom-in"
                ...
                <div class="w-4/6 mx-auto flex justify-between">
                    <h1 class="text-2xl font-semibold text-blue-600 text-left">Company Login</h1>
                    <a href="{{ route('seeker_login') }}" class="text-blue-600 ml-3">Seeker? Login Here</a>
                </div>

                <form action="{{ route('company_login_post') }}" method="post" class="mt-3 w-5/6 mx-auto my-10">
                    @csrf
                    ...
                    <div class="flex justify-between">
                        <a href="{{ route('company_login_reset') }}" class="text-blue-600 ml-3">Forgot Password?</a>
                        <a href="{{ route('company_register') }}" class="text-blue-600 ml-3">Don't Have Account?
                            Register</a>
                    </div>
                    <button type="submit"
