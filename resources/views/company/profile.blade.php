            ...
            <div class="w-full">
                <div class="relative mb-48 ">
                    <div class="relative ">
                        ...
                        <div
                            ...
                            <img src="{{ asset('storage/company/Images/'.$company->logo) }}" alt="" class="w-full rounded-full">
                ...
                <div class="w-5/6 mx-auto elevation-10 bg-gray-300 p-5 rounded-b-2xl">
                    ...
                    <div class="md:flex justify-between items-center">
                        ...
                        <div class="md:w-3/6 md:mx-2">
                            <label for="country" class="text-2xl block text-gray-400">Country </label>
                    ...
                    <div class="md:flex justify-between items-center">
                        <div class="md:w-3/6 md:mx-2">
                            <label for="state" class="text-2xl block text-gray-400">State </label>
                        ...
                        <div class="md:w-3/6 md:mx-2">
                            <label for="city" class="text-2xl block text-gray-400">City </label>
                    ...
                    <div class="md:flex justify-between items-center">
                        ...
                        <div class="md:w-3/6 md:mx-2">
                            <label for="cover" class="text-2xl block text-gray-400">Cover </label>
                    ...
                    <div class="md:flex justify-between items-center">
                        ...
                        <div class="md:w-3/6 md:mx-2">
                            ...
                            <input type="text" name="instagram" id="instagram" value="{{ $social_media['instagram'] }}"
                                class="w-full border-b-4 border-gray-400 rounded text-gray-400">
                        </div>
                    </div>
                       <div class="flex justify-center items-center w-2/6 mx-auto">
                <button type="submit" class="bg-gray-500 hover:bg-gray-600 text-gray-300 py-2 px-11 w-full rounded my-8">Update</button>
            </div>
                </div>
