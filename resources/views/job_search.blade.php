...
<section class="w-11/12 md:w-5/6 mx-auto">
    ...
    <div class="md:flex justify-between items-center">
        ...
        <div class="md:w-4/12 mx-1">
            <form action="{{ route('jobs.search') }}" method="get" class="w-full">
                <input type="text" name="keyword" id="search" placeholder="Search Jobs" class="w-3/5 rounded focus:ring-red-500 ring-red-500 border-0">
                <button class="w-1/5 rounded px-2 py-2 bg-red-500 hover:bg-red-600 text-red-200"><i class="fa-solid fa-magnifying-glass"></i></button> 
            </form>
        </div>
    </div>
