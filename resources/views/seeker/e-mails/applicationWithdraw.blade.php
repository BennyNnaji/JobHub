    ...
    <table class="max-w-2xl mx-auto bg-white p-8 shadow-md rounded-md">
        ...
        <tr>
            <td class="p-4">
                ...
                <p class="text-gray-800">We received your request to withdraw your job application for the
                    {{ $data['job_title'] }} position at {{ $data['company'] }} on JobHub.</p>
                <p class="text-gray-800">Your application status has been updated to <span class="capitalize">withdrawn</span>.</p> <br>
                ...
                <p class="text-gray-800">Thank you for considering JobHub, and we appreciate your engagement with our platform.</p>
                <br>
                <p>Regards,</p>
